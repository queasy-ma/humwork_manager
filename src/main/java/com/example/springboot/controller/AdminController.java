...
public class AdminController {
    ...
    @ResponseBody
    public JSONObject admin(@RequestParam(value = "username",required = false)String username, @RequestParam(value = "password",required = false)String password) throws SQLException {
